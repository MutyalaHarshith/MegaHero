...
@Client.on_message(filters.command('mhid'))
...
@Client.on_message(filters.command(["mhinfo"]))
async def who_is(client, message):
    ...
    dc_id = from_user.dc_id or "[User Doesnt Have A Valid Dispaly Picture]"
...
@Client.on_message(filters.command(["imdb", 'search','harshith']))
